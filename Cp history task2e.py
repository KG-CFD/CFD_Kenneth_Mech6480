...
plt.plot(x2_smooth, Cp2_smooth, label='Cone 2 (smooth)', color='green')  # Smooth line
plt.plot(x2, Cp2, 'gs')  # Actual data points

# Add labels and title
plt.xlabel('Time step')
plt.ylabel('Cp')
plt.title('Coefficient of Pressure over 2 Cone Surfaces at midpoint')
...
# Show the plot
plt.grid(True)
plt.savefig('Task2_Cp_e_spline.png')
plt.show()
